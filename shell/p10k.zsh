# Generated by Powerlevel10k configuration wizard on 2025-07-28 at 19:47 EEST.
...
() {
  ...
  # Grey Node.js version.
  typeset -g POWERLEVEL9K_NODEENV_FOREGROUND=$grey
  typeset -g POWERLEVEL9K_NODEENV_{LEFT,RIGHT}_DELIMITER=

  # Node version (shows in dirs with package.json, .nvmrc, .node-version).
  ...
  # Show git icon before branch name.
